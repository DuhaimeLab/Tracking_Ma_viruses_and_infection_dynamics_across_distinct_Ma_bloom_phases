...
samplename="/nfs/turbo/lsa-duhaimem/ajwing/ajw_chapter_2/erie_isolate_assemblies/ND-$assembly/Megahit_meta-sensitive_out/final.contigs.fa"
outname="/scratch/duhaimem_root/duhaimem/ajwing/ajw_2014_bloom/final_SnakemakePipeline/Kaiju_outputs/$assembly.kaiju.out"
