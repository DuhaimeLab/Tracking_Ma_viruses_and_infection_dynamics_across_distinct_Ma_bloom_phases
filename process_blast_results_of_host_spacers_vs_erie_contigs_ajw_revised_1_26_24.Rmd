---
title: "blast_all_host_spacers_vs_all_erie_viral_contigs"
author: "A.J Wing"
date: "2023-02-15"
...
```{r}
blast_hits <- read_tsv('~/Desktop/erie_story_r_work/all_lake_erie_viruses_vs_all_host_spacers_blastn.csv', col_names=FALSE)
...
names(clusters)[names(clusters) == 'contig'] <- "query_id"
...
```{r}
blast_hits <- left_join(blast_hits,clusters,by="query_id")
```
...
```{r}
clusters_with_dates <- left_join(clusters,VP_number_dates,by="cluster")
